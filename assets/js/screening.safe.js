  ...
  function render(res){
    ...
    try {
      ...
      var summaryLine = [
        ...
        'Employees (FTE): ' + ((form.employees_fte && form.employees_fte.value) ? form.employees_fte.value.trim() : ''),
        'Sites: ' + ((form.sites && form.sites.value) ? form.sites.value.trim() : ''),
        'Score: ' + (res.pct + '%'),
      ...
      if (rf) {
        ...
        // Also pass through FTE and Sites to the request-call form
        ensure('Employees (FTE)', (form.employees_fte && form.employees_fte.value) ? form.employees_fte.value.trim() : '');
        ensure('Sites', (form.sites && form.sites.value) ? form.sites.value.trim() : '');
      }
